...
MAX_GAMES = 2000 # Don't index full sets
...
# SYSTEMS   = [  '3do', '3ds', 'amstradcpc', 'sega32x', 'segacd', 'x68000' ]
            ...
            if vid is not None:
                ...
                try:
                    if os.path.isfile(BASEPATH+system+'/'+v):
                        ...
                        # print ("file {} not found.".format(BASEPATH+system+'/'+v))
                        pass
                except:
                    pass
                if file_vid:
