...
# License: LGPL 3.0
Q = [
        ('Which video game designer created\nMario and Zelda?', 4, 'Hideo Kojima', 'Satoru Iwata', 'Gunpei Yokoi', 'Shigeru Miyamoto' ),
        ('How was the Nintendo Entertainement System\ncalled in South Korea?', 1, 'Hyundai Comboy', 'Samsung Gamicom', 'Goldstar Compai', 'Gangam Metro'),
        ('In 1991, "Titus the Fox" was a remake of a Titus game\noriginally sold in France under the name:', 2, 'Tintin et les Sept Boules de Cristal', 'Lagaf: Les Aventures de Moktar', 'Lucky Luke et la ballade des Dalton', 'Les Guignols de l\'Info'),
        ('What was Lara Croft\'s original name in the early\ndevelopment of Tomb Raider?', 2, 'Leah Drake', 'Laura Cruz', 'Tabatha Crush', 'Carla Raft'),
        ...
        ('The Sega Megadrive was called "Genesis" in the USA\nbecause of a trade mark dispute against:', 4, 'a movie by Universal', 'a video game by Accolade', 'a pharmaceutical medication by Pfizer', 'an American computer storage company'),
        ('What is the Russian name of the\n"Tetris theme Type-A" classical song?', 1, 'Korobeiniki', 'Zubrowskaia Terika', 'Novaya Kalinka', 'Podmoskovnie'),
        ('According to John Romero himself,\nwhat\'s the name of Doom hero?', 4, 'B.J. Blazkowicz', 'Flynn Taggart', 'John Kane', 'Doom Guy'),
        ('Space Invaders hit arcade rooms in:', 3, '1974', '1976', '1978', '1980'),
        ('Nintendo released its Game Boy handheld\nconsole In Japan in:', 1, '1989', '1990', '1991', '1992'),
        ...
        ('When designing \'Donkey Kong\', which character did\nNintendo want to use as the hero before Mario?', 4, 'Superman', 'Pac-Man', 'Archie', 'Popeye'),
        ('What\'s the name of the Russian fighter in\nNintendo Punch-Out?', 2, 'Dimitri Lakkai', 'Soda Popinski', 'Mikhail Gorbinski', 'Boris Stokanov'),
        ...
        ('The PlayStation 2 design is a heavily inspired\nby an old computer manufactured by:', 3, 'Amstrad', 'Commodore Amiga', 'Atari', 'Sinclair'),
        ...
        ('What was the introduction price of the Atari Lynx in 1989,\nthe first color handheld console ever?', 2, '$99', '$149', '$199', '$249'),
        ...
        ('"Another World" (Out of This World) was designed and coded\nby this single person:', 2, 'Paul Cuisset', 'Eric Chahi', 'Michel Ancel', 'Frederick Raynal'),
        ('How is called Central Processing Unit originally designed\nfor the PlayStation 2?', 4, 'Agnes', 'Lightning', 'Magic Wand', 'Emotion Engine'),
        ...
        ('A gene in the human body, ensuring our organs grow at the right place,\n was called after a video game:', 2, 'SMB - Super Mario Bros', 'SHH - Sonic the HedgeHog', 'SF2 - Street Fighter II', 'MGS - Metal Gear Solid'),
        ('In the 1990s, who was a regular Tetris championn, printed out\nin the "Nintendo Power" magazine?', 1, 'Steve Wozniak', 'Bill Gates', 'Mark Zuckerberg', 'Elon Musk'),
        ('When was the first version of Batocera Linux released?', 2, '2015', '2016', '2017', '2018'),
        ('Robin Williams, the deceased actor, was a\nvideo game nerd who named his daughter:', 4, 'Cecil (from Final Fantasy)', 'Daphne (from Dragon\'s Lair)', 'Lara (from Tomb Raider)', 'Zelda (from the Legend of Zelda)'),
        ...
        ('Gunpei Yokoi, the creator of the GameBoy started his career\nat Nintendo as a:', 4, 'Translator', 'HR Recruiter', 'Financial Analyst', 'Janitor'),
        ('Donkey Kong was named as such because Miyamoto\nthought "donkey" in English meant', 3, 'Strong', 'Giant', 'Stupid', 'Monkey'),
        ('What video game did Daniel Barry played on the\nSpace Shuttle mission STS-96 in 1999?', 4, 'Quake', 'Half-Life', 'Grand Theft Auto', 'Starcraft'),
        ('What band made more money from their "Guitar Hero" edition\nthan the sales of any of their previous albums?', 2, 'AC/DC', 'Aerosmith', 'Metallica', 'Van Halen'),
        ...
        ('Henry Cavill missed his first audition for the role of\nSuperman because he was too busy playing:', 2, 'Halo', 'World of Warcraft', 'Call of Duty', 'Guitar Hero'),
        ...
        ('If Mario was a real person, how far would he have to run\nto complete the origianl Super Mario Bros?', 2, '0.9 mile / 1.5 km', '3.4 miles / 5.5 km', '7.5 miles / 12 km', '12.4 miles / 20 km'),
        ('On a global scale, what is the average age of\na video game player', 4, '15', '20', '25', '30'),
        ('Before he was given the name "Mario", what was the name\n of this character in the early Nintendo games?', 4, 'Ooyaji', 'Damaro', 'Felix', 'Jumpman'),
        ('From the litteral Japanese, the Pokemon "Pikachu"\nname would translate in English into:', 1, 'Lightning squeak', 'Cute cat', 'Brave sidekick', 'Yellow blast'),
        ('In the Nintendo games, the full name of Princess Peach is:', 4, 'Peach Rosegarden', 'Peach Mushy', 'Peach Juicy', 'Peach Toadstool'),
        ('In "Burnout Paradise", DJ Atomica makes several\nreferences to another video game:', 1, 'SSX', 'The Sims', 'Need for Speed', 'Medal of Honor'),
        ('In the original Golden Axe, some of the death screams\nare digitized from the movie:', 4, 'Terminator', 'Rambo', 'The Exorcist', 'Conan the Barbarian'),
        ...
        ('The perfect score on the original Pac-Man arcade\ngame was achived in 1999 by Billy Mitchell with:', 2, '999,990 points', '3,333,360 points', '9,999,990 points', '33,666,000 points'),
        ('"World of Warcraft" was the highest grossing video\ngame when it crossed the mark of:', 3, '10 million dollars', '100 million dollars', '10 billion dollars', '100 billion dollars'),
        ...
        ('What\'s the name of the Japanese neuroscientist who helped develop the "Brain Age"\nseries of video games on the Nintendo DS', 4, 'Dr. Kawasaki', 'Dr. Matashima', 'Dr. Mashimata', 'Dr. Kawashima'),
        ...
        ('The American musical duo "Buckner & Garcia" is\nbest known for a song about:', 1, 'Pac-Man', 'Space Invaders', 'Duck Hunt', 'Sonic the Hedgehog'),
        ('Before video games, what product did Nintendo release first?', 4, 'Medical devices', 'Rice cookers', 'Rain boots', 'Playing cards'),
        ('In what game series can you find the\n"Umbrella Corporation" pharmaceutical company?', 1, 'Resident Evil', 'Metal Gear Solid', 'Final Fantasy', 'Fallout'),
        ('In the original "Legend of Zelda", the maximum\namount of rupees you could you get was:', 2, '99', '254', '999', '1024'),
        ...
        ('In a 1993 movie, Bob Hoskins, the famous\nEnglish actor, portrayed:', 1, 'Mario', 'Blanka', 'Dr. Robotnik', 'Sub-Zero'),
        ...
        ('What is the name of the alien alliance in\nthe first "Halo" games?', 4, 'The Horde', 'The Chozo', 'The Perdition', 'The Covenant'),
        ('What is the name of the woman to be saved by\nMario in the original Donkey Kong game?', 4, 'Camilla', 'Peach', 'Rosalina', 'Pauline'),
        ...
        ('What was the name of the peripheral device\nadding vibration to the Nintendo 64 controller?', 3, 'Vibratron', 'Visual Memory Unit', 'Rumble Pak', 'Haptic 64'),
        ('Which character goes by the codename "Killer Bee"?', 4, 'Bayonetta', 'Lara Croft', 'Meryl Silverburgh', 'Cammy'),
        ('In "Metal Gear", Solid and Liquid Snake were born\nas a result of which secret operation?', 1, 'Les Enfants Terribles', 'Les Miserables', 'Guernica', 'The Beauty and the Beast'),
        ...
        ('Which video game series has "Underground", "Most Wanted"\nand "Hot Pursuit" installments?', 4, 'Call of Duty', 'Burnout', 'Medal of Honor', 'Need for Speed'),
        ...
        ('Who wrote successful adventure games in the 1980s and 1990s\nlike "Dark Crystal", "King\'s Quest" and "Phantasmagoria"?', 1, 'Roberta Williams', 'Tim Schafer', 'Ron Gilbert', 'David Cage'),
