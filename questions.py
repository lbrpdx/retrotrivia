...
Q = [
        ...
        ('The 1993 arcade orginal NBA Jam was made by who?', 3, 'EA Sports', 'Acclaim', 'Midway', 'Sega'),
        ...
        ('Known as Mega Man to many, in Japan he is', 3, 'Superman', 'Powerman', 'Rockman', 'Bigman'),
        ...
        ('The Japanese NES game "Captain Tsubasa" was released as "Tecmo Cup Soccer/Football Game" in America and Europe. Its main character was also renamed as:', 2, 'Mike Robertson', 'Robin Field', 'Leo Berlino', 'Jeff Fighter'),
        ('When was the very first edition of "Call of Duty" released?', 3, '2001', '2002', '2003', '2004'),
        ('What color is the evil tentacle in Maniac Mansion and the Day of the Tentacle?', 4, 'Green', 'Yellow', 'Red', 'Purple'),
        ('What NES game first introduced the Konami Code?', 2, 'Contra', 'Gradius', 'Green Beret', 'Typhoon'),
        ('Before choosing Kirby, Nintendo\'s pink hero was originally named:', 3, 'Roodoodoo', 'Jiggly Johnny', 'Tinkle Popo', 'Pinko Rino'),
        ('The Atari Jaguar used two 32-bit CPUs called:', 3, 'Mickey & Minnie', 'Bernard & Bianca', 'Tom & Jerry', 'Wallace & Gromit'),
        ('In 2006, Quentin Tarantino expanded the universe of which movie with a game for PS2 and Xbox?', 1, 'Reservoir Dogs', 'Kill Bill', 'Pulp Fiction', 'From Dusk till Dawn'),
        ('Which game studio often includes a secret room, where all objects are available, when typing the code "QASMOKE"?', 3, 'Rockstar North', 'Naughty Dog', 'Bethesda Softworks', 'Id Software'),
        ('What was the first game created by LucasArts originally on Atari 8-bit computers?', 3, 'Star Raiders', 'Parsec', 'Ballblazer', 'Maniac Mansion'),
        ('How many Zelda games were released on the Philips CD-I console?', 3, '1', '2', '3', 'None, zero, zilch'),
        ('What was the first home console to use CD-ROMs as the primary storage?', 3, 'Sega Saturn', 'Sony Playstation', 'NEC TurboGrafx-CD', 'Panasonic 3DO'),
        ('What is the native resolution of the Super Nintendo (SNES)?', 2, '160x144', '256x224', '320x240', '640x480'),
        ('What is the maximum number of colors the NES can display on screeen at once?', 2, '16', '25', '64', '127'),
        ('Which game was the first to use a battery backup in the cartridge for saving progress?', 3, 'Final Fantasy', 'Metroid', 'The Legend of Zelda', 'Dragon Quest'),
#        ('', 4, '', '', '', ''),
     ]
