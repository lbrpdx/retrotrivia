...
Q = [
	...
	('In 1995 Nintendo released a console that poorly attempted at virtual reality called:', 4, 'Virtual Goggles', 'Virtual Bot', 'Nintendo 3D', 'Virtual Boy' ),
	('PC Engine SuperGrafx released at the end of 1989 had how many games in total?', 2, '2', '7', '345', '1106' ),
	('In an attempt at combining a cell phone and portable gaming console the N-Gage was produced by what company?', 3, 'Samsung', 'Nostalgia Electrics', 'Nokia', 'Neo-Geo' ),
	('Atari released a home gaming console named after what cat?', 1, 'Jaguar', 'Panther', 'Tiger', 'Maine Coone' ),
